...
const requiredFragments = [
  'src="/assets/js/site-data.js?v=0.1.6"',
  'src="/assets/js/site.js?v=0.1.6"',
...
if (!siteJs.includes('const WISIK_CONTEXT_KEY = "wisik-last-attraction-context-v1"') || !siteJs.includes("applyFeedbackSourceContext")) throw new Error("Automatische bron- en productcontext voor Kladblok ontbreekt");
