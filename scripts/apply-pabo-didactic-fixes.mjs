...
s=s.replaceAll('1.7.0','1.7.1');
fs.writeFileSync(file,s);
for(const name of ['public/index.html','public/pabo/pabo-rekenklaar/index.html','public/moshpit/index.html','public/assets/js/site-data.js']){let x=fs.readFileSync(name,'utf8');x=x.replaceAll('1.7.0','1.7.1');fs.writeFileSync(name,x)}
console.log('Didactische correctie en alle publieke versieaanduidingen 1.7.1 toegepast.');
