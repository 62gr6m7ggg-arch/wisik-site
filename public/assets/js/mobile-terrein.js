...
(() => {
  ...
  const sequence = [".zone-pabo", ".side-stage-card.moshpit", ".side-stage-card.grabbelton", ".zone-space", ".kh-entry--map", ".space-billboard-map", ".zone-vo", ".zone-hbo", ".zone-backstage", ".zone-kladblok"];
